...
module {
  memref.global "private" constant @__constant_24x64x64xf32 : memref<24x64x64xf32> = dense<1.000000e+00> alignment = 64
  func.func @simple_gemm(%arg0: memref<8x24x32x64xf32>) -> memref<8x24x32x64xf32> {
    ...
    %alloc = memref.alloc() alignment = 64 : memref<8x24x32x64xf32>
...
// CHECK-LABEL:   memref.global "private" constant @__constant_24x64x64xf32 : memref<24x64x64xf32> = dense<1.000000e+00> alignment = 64
...
// CHECK:           %[[VAL_10:.*]] = memref.alloc() alignment = 64 : memref<8x24x32x64xf32>
...
#map2 = affine_map<(d0, d1, d2, d3) -> (d1, d2)>
module {
  memref.global "private" constant @__constant_48x32x32xf32 : memref<48x32x32xf32> = dense<1.000000e+00> alignment = 64
  func.func @chainned_gemm(%arg0: memref<8x48x32x32xf32>) -> memref<8x48x32x32xf32> {
    ...
    %alloc = memref.alloc() alignment = 64 : memref<8x48x32x32xf32>
    ...
    %alloc_1 = memref.alloc() alignment = 64 : memref<8x48x32x32xf32>
    scf.forall (%arg1, %arg2) in (8, 48) {
...
// CHECK-LABEL:   memref.global "private" constant @__constant_48x32x32xf32 : memref<48x32x32xf32> = dense<1.000000e+00> alignment = 64
...
// CHECK:           %[[VAL_9:.*]] = memref.alloc() alignment = 64 : memref<8x48x32x32xf32>
...
// CHECK:             }
// CHECK:           }
// CHECK:           %[[VAL_29:.*]] = memref.alloc() alignment = 64 : memref<8x48x32x32xf32>
...
// CHECK-LABEL:   memref.global "private" constant @__constant_16x32x64x2xbf16 : memref<16x32x64x2xbf16> = dense<1.000000e+00> alignment = 64
...
// CHECK:           %[[VAL_9:.*]] = memref.alloc() alignment = 64 : memref<4x16x64x64xbf16>
...
// CHECK:           %[[VAL_5:.*]] = memref.alloc() alignment = 64 : memref<8x24x32x64xf32>
