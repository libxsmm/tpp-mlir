...
module {
  memref.global "private" constant @__constant_4x1x4x2xbf16 : memref<4x1x4x2xbf16> = dense<1.000000e+00> alignment = 64
  func.func @entry(%arg0: memref<2x4x8x2xbf16>) -> memref<2x2x8x4xbf16> {
    ...
    %alloc = memref.alloc() alignment = 64 : memref<2x2x8x4xbf16>
