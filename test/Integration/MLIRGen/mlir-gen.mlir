...
// RUN: mlir-gen --identity --kernel=const --seed=0 --data-type=mx-f32-i8 --batch=3 --layers=3,3 --test-quant | tpp-run -e entry -entry-point-result=void -print --splat-to-random --init-type normal  -seed 123 > %t.2
