...
llvm::cl::opt<std::string> outputOpKind(
    "output", llvm::cl::desc("Specifies linalg op kind generic, einsum or named"),
    llvm::cl::value_desc("generic,einsum,named"), llvm::cl::init("generic"));
